...
public enum QueryOffsetPolicy
  ...
  /**
   * <code>QUERY_OFFSET_POLICY_UNSPECIFIED = 0;</code>
   */
   ...
   * <code>QUERY_OFFSET_POLICY_UNSPECIFIED = 0;</code>
   */
  public static final int QUERY_OFFSET_POLICY_UNSPECIFIED_VALUE = 0;
  /**
   * <pre>
   * Use this option if client wishes to playback all existing messages.
   * </pre>
  ...
  public static QueryOffsetPolicy forNumber(int value) {
    switch (value) {
      case 0: return QUERY_OFFSET_POLICY_UNSPECIFIED;
