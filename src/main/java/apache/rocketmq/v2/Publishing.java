...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (getCompressThreshold()
        != other.getCompressThreshold()) return false;
    if (getMaxMessageBytes()
        != other.getMaxMessageBytes()) return false;
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + COMPRESS_THRESHOLD_FIELD_NUMBER;
    hash = (53 * hash) + getCompressThreshold();
    hash = (37 * hash) + MAX_MESSAGE_BYTES_FIELD_NUMBER;
    hash = (53 * hash) + getMaxMessageBytes();
  ...
  public static final class Builder extends
    ...
    public apache.rocketmq.v2.Publishing buildPartial() {
      ...
      result.compressThreshold_ = compressThreshold_;
    ...
    public Builder mergeFrom(apache.rocketmq.v2.Publishing other) {
      ...
      if (other.getCompressThreshold() != 0) {
        setCompressThreshold(other.getCompressThreshold());
      }
      if (other.getMaxMessageBytes() != 0) {
        setMaxMessageBytes(other.getMaxMessageBytes());
      }
     ...
     */
    public Builder setCompressThreshold(int value) {
      
      compressThreshold_ = value;
      onChanged();
      return this;
    }
    /**
